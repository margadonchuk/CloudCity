...
SELECT 'VPS1-1-20', 'vps1-1-20', 3, 'Netherlands/Germany/France', 10.00, '1 Core, 1GB RAM, 20GB SSD', 1, 1, '/images/vps_1-1-20.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps1-1-20');
GO

-- VPS2-2-40
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS2-2-40', 'vps2-2-40', 3, 'Netherlands/Germany/France', 20.00, '2 Cores, 2GB RAM, 40GB SSD', 1, 1, '/images/vps_2-2-40.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps2-2-40');
GO

-- VPS3-2-150
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS3-2-150', 'vps3-2-150', 3, 'Netherlands/Germany/France', 35.00, '2 Cores, 4GB RAM, 150GB SSD', 1, 1, '/images/vps_3-2-150.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps3-2-150');
GO

-- VPS4-4-80
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS4-4-80', 'vps4-4-80', 3, 'Netherlands/Germany/France', 49.00, '4 Cores, 4GB RAM, 80GB SSD', 1, 1, '/images/vps_4-4-80.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps4-4-80');
GO

-- VPS5-6-100
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS5-6-100', 'vps5-6-100', 3, 'Netherlands/Germany/France', 80.00, '6 Cores, 12GB RAM, 100GB SSD', 1, 1, '/images/vps_5-6-100.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps5-6-100');
GO

-- VPS6-8-120
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS6-8-120', 'vps6-8-120', 3, 'Netherlands/Germany/France', 95.00, '8 Cores, 8GB RAM, 120GB SSD', 1, 1, '/images/vps_6-8-120.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps6-8-120');
GO

-- VPS7-8-160
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS7-8-160', 'vps7-8-160', 3, 'Netherlands/Germany/France', 150.00, '8 Cores, 16GB RAM, 160GB SSD', 1, 1, '/images/vps_7-8-160.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps7-8-160');
GO

-- VPS8-8-200
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS8-8-200', 'vps8-8-200', 3, 'Netherlands/Germany/France', 175.00, '8 Cores, 24GB RAM, 200GB SSD', 1, 1, '/images/vps_8-8-200.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps8-8-200');
GO

-- VPS9-12-300
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS9-12-300', 'vps9-12-300', 3, 'Netherlands/Germany/France', 220.00, '12 Cores, 48GB RAM, 300GB SSD', 1, 1, '/images/vps_9-12-300.png'
WHERE NOT EXISTS (SELECT 1 FROM Products WHERE Slug = 'vps9-12-300');
GO

-- VPS10-16-320
INSERT INTO Products (Name, Slug, Type, Location, PricePerMonth, Configuration, IsAvailable, IsPublished, ImageUrl)
SELECT 'VPS10-16-320', 'vps10-16-320', 3, 'Netherlands/Germany/France', 249.00, '16 Cores, 32GB RAM, 320GB SSD', 1, 1, '/images/vps_10-16-320.png'
